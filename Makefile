...
all:
	...
	cd /var/lib/lxc/home/dome/devel/lixen_app/build/lua-cjson-1.0.3 && $(MAKE) DESTDIR=$(DESTDIR) LUA_INCLUDE_DIR=/var/lib/lxc/home/dome/devel/lixen_app/build/luajit-root/opt/lixen/luajit/include/luajit-2.0 LUA_LIB_DIR=/opt/lixen/lualib CC=gcc
	...
	cd /var/lib/lxc/home/dome/devel/lixen_app/build/nginx-1.4.1 && $(MAKE)
...
install: all
	...
	cd /var/lib/lxc/home/dome/devel/lixen_app/build/lua-cjson-1.0.3 && $(MAKE) install DESTDIR=$(DESTDIR) LUA_INCLUDE_DIR=/var/lib/lxc/home/dome/devel/lixen_app/build/luajit-root/opt/lixen/luajit/include/luajit-2.0 LUA_LIB_DIR=/opt/lixen/lualib CC=gcc
	...
	cd /var/lib/lxc/home/dome/devel/lixen_app/build/nginx-1.4.1 && $(MAKE) install DESTDIR=$(DESTDIR)
